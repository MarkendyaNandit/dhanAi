...
export const fetchHistory = async (userId) => {
    const response = await fetch(`${API_URL}/ai-extract?userId=${userId}`, {
...
export const syncTransactions = async () => {
    const response = await fetch(`${API_URL}/ai-extract/sync`, {
        headers: getAuthHeaders()
    });
...
export const updateOverview = async (transactions, totalIncome, totalExpense, userId, persist) => {
    const response = await fetch(`${API_URL}/ai-extract/update-overview`, {
        method: 'POST',
        headers: getAuthHeaders(),
...
export const addManualTransaction = async (txData) => {
    const response = await fetch(`${API_URL}/ai-extract/transaction`, {
        method: 'POST',
        headers: getAuthHeaders(),
...
export const parseText = async (text) => {
    const response = await fetch(`${API_URL}/ai-extract/parse-text`, {
        method: 'POST',
        headers: getAuthHeaders(),
